...
DESCRIPTION = "A tool for seeding torrents from the web."
URL = "https://github.com/zackees/webtorrent-seeder"
EMAIL = "dont@email.me"
AUTHOR = "Zach Vorhies"
...
with open(os.path.join(HERE, "webtorrent_seeder", "version.py"), encoding="utf-8", mode="rt") as fd:
